...
WORKFLOW_DESCRIPTION = (
    ...
    "gs://bucket-name/path/to/document.pdf), you MUST generate a proxy URL and display it "
    "using an iframe.\n"
    f"- Construct the document proxy URL by taking the base agent URL '{AGENT_URL}' "
    "and appending '/pdf?url=' followed by the full GCS URI. "
    f"For example: if the GCS URI is gs://hcls-ge-documents/roi_2025_health.pdf, the proxy URL is "
